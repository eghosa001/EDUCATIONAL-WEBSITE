      ...
      {flashcards.length > 0 ? (
        <div className="bg-white rounded-xl border border-gray-200 p-8">
          ...
          <div className="flex items-center justify-between mt-6">
            ...
            <div className="flex gap-2">
              <button className="px-4 py-2 text-sm text-red-600 border border-red-200 rounded-xl hover:bg-red-50">
                Hard
              </button>
              <button className="px-4 py-2 text-sm text-yellow-600 border border-yellow-200 rounded-xl hover:bg-yellow-50">
                Good
              </button>
              <button className="px-4 py-2 text-sm text-green-600 border border-green-200 rounded-xl hover:bg-green-50">
                Easy
              </button>
            </div>
            <button
