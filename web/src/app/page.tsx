    ...
    <div className="min-h-screen bg-stone-50 text-slate-900 dark:bg-[#151A3A] dark:text-slate-100">
      <nav className="sticky top-0 z-50 border-b border-stone-200/80 bg-white/95 backdrop-blur-sm dark:border-slate-700/80 dark:bg-[#151A3A]/95">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link href="/" aria-label="THE GUIDE home" className="flex items-center">
            <img src="/logos/primary-logo.jfif" alt="THE GUIDE — Your path to smarter learning" className="h-14 w-auto max-w-[220px] object-contain" />
          </Link>
      ...
      <section className="relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <img src="/logos/app-icon.jfif" alt="THE GUIDE" className="mx-auto mb-7 h-28 w-28 rounded-[28%] object-cover shadow-brand sm:h-32 sm:w-32" />
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="brand-gradient brand-glow rounded-2xl px-8 py-12 text-center sm:px-16 sm:py-16">
            <img src="/logos/app-icon.jfif" alt="THE GUIDE" className="mx-auto mb-6 h-20 w-20 rounded-2xl object-cover shadow-brand" />
      ...
      <footer className="border-t border-stone-200 bg-white dark:border-slate-700 dark:bg-[#151A3A]">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 py-8 sm:flex-row sm:px-6 lg:px-8">
          <Link href="/" aria-label="THE GUIDE home"><img src="/logos/primary-logo.jfif" alt="THE GUIDE" className="h-12 w-auto max-w-[180px] object-contain" /></Link>
